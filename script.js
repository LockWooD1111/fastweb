/* =========================================
   ...
   document.addEventListener('DOMContentLoaded', () => {
    ...
    if (nameInput) nameInput.addEventListener('input', () => clearError('name', 'nameError'));
    if (emailInput) emailInput.addEventListener('input', () => clearError('email', 'emailError'));
    if (contactInput) contactInput.addEventListener('input', () => clearError('contact', 'contactError'));
    ...
    if (form) {
      form.addEventListener('submit', async (e) => {
        ...
        try {
          ...
          // На localhost fetch упадёт — всё равно показываем success для теста
        }
    ...
    if (businessSelect) {
      businessSelect.addEventListener('change', function() {
        ...
        if (otherGroup) otherGroup.style.display = this.value === 'Other' ? 'block' : 'none';
      });
    }
